...
This project will use the Student file (STUFILE.TXT). It will first be converted into an Indexed Sequential file. The file for the Program Records will remain the same as a Line Sequential file.
